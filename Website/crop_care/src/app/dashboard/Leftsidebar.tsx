    ...
    <div className='bg-slate-800'>
        ...
        <div className='flex flex-col w-full px-10 py-3 rounded-xl items-center absolute top-0 left-0 bg-slate-800 h-full'>
          ...
          <ul className='py-5 pt-3 w-full text-center'>
            <li className='text-slate-100 items-center px-3 py-2 my-3 font-medium rounded-md hover:bg-cyan-300'><Link className='' href={links[1].link}>{links[1].name}</Link></li>
            <li className='text-slate-100 px-3 py-2 my-3 font-medium rounded-md hover:bg-cyan-300'><Link className='' href={links[0].link}>{links[0].name}</Link></li>
            <li className='text-slate-100 px-3 py-2 my-3 font-medium rounded-md hover:bg-cyan-300'><Logout  /></li>
          </ul>
